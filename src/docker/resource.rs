...
impl DockerResources {
    pub(crate) fn from_workspace(
        ...
        Self {
            ...
            image_tag: format!("decune/{resource_basename}:{config_hash}"),
            labels,
            config_hash,
        }
    }
...
mod tests {
    ...
    fn resources_include_names_and_labels_from_workspace_and_config_hash() {
        ...
        assert_eq!(
            resources.image_tag,
            format!("decune/{}:abc123def456", workspace.basename())
        );
    ...
    fn resource_names_sanitize_workspace_basename_for_docker() {
        ...
        assert_eq!(resources.image_tag, "decune/project-name:abc123");
    }
